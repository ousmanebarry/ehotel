...
import { TextInput, PasswordInput, Button, Text, Stack, Center, Group, NumberInput } from '@mantine/core';
...
export default function SignUp() {
	...
	const handleSubmit = form.onSubmit(async (info) => {
		try {
			const res = await axios.post(`${process.env.NEXT_PUBLIC_URL}/auth/customers`, {
