			...
			<main>
				<Center sx={{ marginTop: '20px', marginBottom: '20px' }}>
					<Flex wrap='wrap' gap='30px'>
						...
						{props.bookings.length === 0 && <Text>You do not currently have any bookings</Text>}
					</Flex>
				</Center>
			</main>
		</>
...
export const getServerSideProps: GetServerSideProps<BookingsProps> = async (context) => {
	...
	const { data } = await axios.get<BookingInfo[]>(`${process.env.NEXT_PUBLIC_URL}/booking/booking`, {
